import{j as t}from"./iframe-CM3h47Pf.js";import{F}from"./FormControl-DNSu1jEy.js";import{F as j}from"./FormControlLabel-CH7xsC8B.js";import{S as k}from"./Switch-CR7YfZf9.js";import"./styled-DspZaNH0.js";import"./utils-DoM3o7-Q.js";import"./useFormControl-BCi-nmTG.js";import"./generateUtilityClasses-BkYpawWM.js";import"./isMuiElement-DnV2LNbe.js";import"./formControlState-Dq1zat_P.js";import"./Typography-CxaJ7SmR.js";import"./Stack-Dif7eGMF.js";import"./SwitchBase-DlkZSi--.js";import"./useControlled-nTii91Zb.js";import"./ButtonBase-DVaQIUUB.js";import"./useTimeout-RdUEBmnf.js";import"./TransitionGroupContext-DluSgF3d.js";import"./useIsFocusVisible-DCSkjDCX.js";const z=({label:x,formlabelProps:L,color:w="default",...v})=>{const{sx:C,...D}=L||{};return t.jsx(F,{children:t.jsx(j,{control:t.jsx(k,{...v,color:w,disableRipple:!0}),label:x,labelPlacement:"start",sx:{gap:1,m:0,...C},...D})})};z.__docgenInfo={description:"",methods:[],displayName:"Switch",props:{color:{required:!1,tsType:{name:"union",raw:'"default" | "primary" | "secondary" | "info"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"primary"'},{name:"literal",value:'"secondary"'},{name:"literal",value:'"info"'}]},description:"",defaultValue:{value:'"default"',computed:!1}},label:{required:!1,tsType:{name:"string"},description:""},formlabelProps:{required:!1,tsType:{name:"Omit",elements:[{name:"MuiFormControlLabelProps"},{name:"union",raw:'"label" | "control"',elements:[{name:"literal",value:'"label"'},{name:"literal",value:'"control"'}]}],raw:'Omit<MuiFormControlLabelProps, "label" | "control">'},description:""}},composes:["Omit"]};const U={title:"ATOMS/Switch/Switch",component:z,parameters:{controls:{exclude:["label","formlabelProps","formControlProps","checked","disabled"]}},argTypes:{color:{options:["default","primary","secondary","info"],control:{type:"select"}},size:{control:{type:"select"},options:["medium","small"]}}},e={args:{color:"primary",size:"medium"}},r={args:{color:"primary",size:"medium",label:"Start",formlabelProps:{labelPlacement:"start"}}},a={args:{color:"primary",size:"medium",label:"End",formlabelProps:{labelPlacement:"end"}}},o={args:{color:"primary",size:"medium",disabled:!0}},s={args:{color:"primary",size:"medium",disabled:!0,checked:!0}};var l,m,i;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    size: "medium"
  }
...
}`,...(S=(P=s.parameters)==null?void 0:P.docs)==null?void 0:S.source}}};const W=["Default","LabelLeft","LabelRight","Disabled","DisabledChecked"];export{e as Default,o as Disabled,s as DisabledChecked,r as LabelLeft,a as LabelRight,W as __namedExportsOrder,U as default};
